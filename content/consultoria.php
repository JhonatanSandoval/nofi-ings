...
<div class="row margin-bottom-30">
    ...
    <div class="col-md-6">
        <p>
            <a data-featherlight="image" href="fotos/consultoria/comerciales/a Semi Sotano.jpg">
                <img class="alignnone" src="fotos/consultoria/comerciales/a Semi Sotano.jpg" alt="61" height="420" width="840">
            </a>
        </p>
    </div>
