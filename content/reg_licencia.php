...
<div class="row margin-bottom-30">
    ...
    <div class="col-md-6">
        ...
        <p>
           (Construcciones avanzadas en cualquier etapa o nivel)
        </p>

    </div>
    <div class="col-md-6">
        <p>
            <a data-featherlight="image" href="images/68.jpg">
                <img class="alignnone" src="images/68.jpg" alt="61" height="420" width="840">
            </a>
        </p>
    </div>
