...
include 'global.php';
$Galeria = array(
    'fachadas1.jpg', 'fachadas2.jpg', 'fachadas3.jpg', 'fachadas4.jpg', 'fachadas5.jpg', 'fachadas6.jpg',
    'fachadas7.jpg', 'fachadas8.jpg', 'fachadas9.jpg', 'fachadas10.jpg', 'fachadas11.jpg', 'fachadas12.jpg'
);
            ...
            <main id="main" class="site-main  col-xs-12  col-lg-9  col-lg-push-3" role="main">
                ...
                <div class="row margin-bottom-30">
                    ...
                    <div class="col-md-6">
                        ...
                        <h4>Construcci&oacute;n de fachadas</h4>
                        ...
                        <p>
                            ...
                            <a class="btn btn-primary boton_amarillo img_gallery" target="_self"
                               rel="gallery" href="fachadas/<?php echo $Galeria[0]; ?>">
                                Galería de Imágenes
                            </a>
                        ...
                        <div style="display: none;">
                            ...
                            for ($x = 0; $x < count($Galeria); $x++) {
                                ?>
                                <a class="img_gallery" href="fachadas/<?php echo $Galeria[$x]; ?>"
                                   rel="gallery"></a>
                                <?php
                            }
                            ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <p>
                            <a data-featherlight="image" href="images/26.jpg">
                                <img class="alignnone" src="images/26.jpg" alt="61" height="420" width="840">
                            </a>
                        </p>

                        <p>
                            <a data-featherlight="image" href="images/3.jpg">
                                <img class="alignnone" src="images/3.jpg" alt="25" height="420" width="840">
                            </a>
                        </p>
