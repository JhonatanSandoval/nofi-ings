...
include 'global.php';
$Galeria = array(
    'obras2.jpg', 'obras3.jpg', 'obras4.jpg', 'obras5.jpg', 'obras6.jpg', 'obras7.jpg', 'obras8.jpg'
);
            ...
            <main id="main" class="site-main  col-xs-12  col-lg-9  col-lg-push-3" role="main">
                ...
                <div class="row margin-bottom-30">
                    ...
                    <div class="col-md-6">
                        ...
                        <h4>Supervisi&oacute;n de obras</h4>
                        ...
                        <p>
                            ...
                            <a class="btn btn-primary boton_amarillo img_gallery" target="_self"
                               rel="gallery" href="obras/<?php echo $Galeria[0]; ?>">
                                Galería de Imágenes
                            </a>
                        ...
                        <div style="display: none;">
                            ...
                            for ($x = 0; $x < count($Galeria); $x++) {
                                ?>
                                <a class="img_gallery" href="obras/<?php echo $Galeria[$x]; ?>"
                                   rel="gallery"></a>
                                <?php
                            }
                            ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <p>
                            <a data-featherlight="image" href="images/42.jpg">
                                <img class="alignnone" src="images/42.jpg" alt="61" height="420" width="840">
                            </a>
                        </p>

                        <p>
                            <a data-featherlight="image" href="images/67.jpg">
                                <img class="alignnone" src="images/67.jpg" alt="25" height="420" width="840">
                            </a>
                        </p>
